...
%--------------------------------------------------------------------------
\title{\Large End-to-end co-design and Responsible Robotics}
\subtitle{Some food for thought in the context of HRI}
\date{{\bf  Institut de Robòtica i Informàtica Industrial} | UPC, 14 Dec 2023}
...
\licenseframe{github.com/severin-lemaignan/presentation-iri-codesign-responsible-robotics}
...
\begin{frame}{Do we actually really want to understand our robots?}
    ...
    %\bubble<5>[200][0.5][6cm]{mark1}{extrapolating from known mental models; building the model implicitly while interacting;...}

    %\bubble<6>[220][0.5][5cm]{mark2}{once established, the model remains essentially stable and valid over time}
